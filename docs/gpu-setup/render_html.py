...
<title>Running the AI on our own GPU: setup</title>
<style>{STYLE}</style>
</head>
<body>
<a class="back" href="https://dev.agent.fordev.fun/docs/">All documents</a>
<div class="masthead">
  <p class="eyebrow">Technical setup</p>
  <p class="title">Running the AI on our own GPU</p>
  <p class="sub">Everything needed to create the machine and wire it to the Service Assistant: the quota that blocks everything else, the AWS permissions, the instance, the two mechanisms that stop it when nobody is using it, and how to check each one actually works.</p>
  <p class="by">Abad Naseer &nbsp;&middot;&nbsp; 29 August 2026 &nbsp;&middot;&nbsp; written to be followed by somebody who is not us</p>
</div>
{toc_html}
{body}
</body>
