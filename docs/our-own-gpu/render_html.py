...
<title>Our own GPU, in plain words</title>
<style>{STYLE}</style>
</head>
<body>
...
<div class="masthead">
  ...
  <p class="sub">What it means to run the AI on hardware we control, what it costs when it is on and when it is off, the one button that switches it, and what happens if somebody forgets to switch it back.</p>
  <p class="by">Abad Naseer &nbsp;&middot;&nbsp; 29 August 2026</p>
</div>
{toc_html}
{body}
</body>
