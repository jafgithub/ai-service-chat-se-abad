...
<title>Installing the open model, and wiring it to FastAPI</title>
<style>{STYLE}</style>
</head>
<body>
...
<div class="masthead">
  ...
  <p class="sub">The software half of running our own AI: installing Ollama, choosing and pulling a model, making it reachable, and the four modules on the FastAPI side that decide where a question goes. Includes how to run the whole thing with no GPU at all.</p>
  <p class="by">Abad Naseer &nbsp;&middot;&nbsp; 29 August 2026 &nbsp;&middot;&nbsp; every command run against a real machine</p>
</div>
{toc_html}
{body}
</body>
