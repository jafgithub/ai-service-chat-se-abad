...
function CategoryTile({
  ...
  return (
    <button
      ...
      aria-label={`Order ${category.title}`}
    >
      <div
...
export function ProductCategories({ onCategorySelect }: ProductCategoriesProps) {
  return (
    <section id="products" className="py-24 bg-surface-sunken">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="max-w-xl mx-auto text-lg text-ink-muted">
            Select a category and our AI will guide you straight to the right products.
          </p>
        </div>
        ...
        <p className="text-center text-ink-faint text-sm mt-10">
          More categories coming soon — curated by our team.
        </p>
      </div>
    </section>
  );
