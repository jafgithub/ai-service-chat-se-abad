...
/**
 * Details shown by pointing at a card, without clicking.
 *
 * Two things it deliberately does not do:
 *
 *   • It never appears on a touch screen. A phone has no hover; browsers fake
 *     one on first tap, which would put a panel over the card somebody
 *     was trying to press. Gated on a pointer that can actually hover.
 *
 *   • It does not fetch anything. Everything shown came down with the results
 *     already, so pointing at twenty cards in a row costs nothing.
 *
...
export function HoverCard({ children, panel, className }: HoverCardProps) {
